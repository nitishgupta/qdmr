...
do
  for SPLIT_TYPE in full-20 # full-20 full-50 full-40 full-30
  do
    for seed in 1 2 3
    do
      MODEL_DIR=/shared/nitishg/qdmr/semparse-gen/checkpoints/${DATASET_NAME}/${SPLIT_TYPE}/Seq2Seq-bert/BS_16/INORDER_true/ATTNLOSS_${attn}/S_${seed}
      # MODEL_DIR=/shared/nitishg/qdmr/semparse-gen/checkpoints/${DATASET_NAME}/${SPLIT_TYPE}/Grammar-bert/BS_16/ATTNLOSS_${attn}/S_${seed}
