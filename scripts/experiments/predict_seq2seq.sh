...
# SAVED MODEL
MODEL_DIR=/shared/nitishg/qdmr/semparse-gen/checkpoints/DROP/template-split/Seq2Seq-glove/BS_64/S_1
...
PREDICTOR=seq2seq_predictor
PREDICTION_FILE=${PREDICTION_DIR}/dev_predictions.txt
