...
@Predictor.register("my-constituency-parser-whitespace")
class ConstituencyParserPredictorWhiteSpace(Predictor):
    """
    ...
    def predict_instance(self, instance: Instance) -> JsonDict:
        ...
        outputs["hierplane_tree"] = self._build_hierplane_tree(tree, 0, 0, is_root=True)
    ...
    def predict_batch_instance(self, instances: List[Instance]) -> List[JsonDict]:
        ...
        for output in outputs:
            ...
            output["hierplane_tree"] = self._build_hierplane_tree(tree, 0, 0, is_root=True)
    ...
    def _build_hierplane_tree(self, tree: Tree, index: int, start_token_index: int, is_root: bool) -> JsonDict:
        ...
        hierplane_node = {
            ...
            "end": start_token_index + num_tokens - 1,
            "nodeType": label,
            "attributes": [label],
            "link": label,
        }
